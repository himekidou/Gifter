...
<body> 
	<div class="main">
	 ...
	 <div id="setting" class="text-center" style="width: 350px; height: 140px; background-color: white; margin-left: 85px; margin-top: 220px; border-radius: 10px;">
		<h5 style="color: black;">허용되지 않은 메소드로</h5>
		<h5 style="color: black;">요청했습니다</h5><br/>
