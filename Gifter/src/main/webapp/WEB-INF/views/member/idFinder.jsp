...
<body> 
	...
	<div id="setting" class="border border-dark  align-items-center" style="width:320px; height:280px; margin: 145px; background-color: white;  background: rgba(255, 255, 255, 0.25); ">
	<div class="text-center" style="color: black;">
	<br/>
	<h3 style="color: black;">아이디 찾기</h3>
	<h7>가입할 때 입력한 이메일을 적어 주세요</h7><br/><br/>
	</div>
